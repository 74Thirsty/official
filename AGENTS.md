...
- Optional streaming: `FACEBOOK_ACCESS_TOKEN` + `FACEBOOK_PAGE_ID` (Facebook auto-detection), `FACEBOOK_PAGE_URL` (Facebook fallback link), `YOUTUBE_API_KEY` (YouTube live detection for the two approved channels).
