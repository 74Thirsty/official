...
export const ONBOARDING_MASTER_TEMPLATE = Object.freeze({
...
export const GRANT_MASTER_TEMPLATE = Object.freeze({
  ...
  sections: [
    ...
    section('budget', 'Budget', [
      ...
      field('match_requirement', 'Match requirement', 'textarea', { required: false, maxlen: 1000 }),
    ...
    section('award', 'Award', [
      ...
      field('award_amount', 'Award amount (USD)', 'number', { required: false }),
      field('award_restrictions', 'Award restrictions', 'textarea', { required: false, maxlen: 2000 }),
      field('grant_period', 'Grant period', 'text', { required: false, maxlen: 120 }),
      field('reporting_deadlines', 'Reporting deadlines', 'textarea', { required: false, maxlen: 2000 }),
      field('closeout_requirements', 'Closeout requirements', 'textarea', { required: false, maxlen: 2000 }),
    ]),
...
export const TEMPLATES = Object.freeze(Object.fromEntries(
  [ONBOARDING_MASTER_TEMPLATE, GRANT_MASTER_TEMPLATE, EVENT_MASTER_TEMPLATE, SAFETY_TRAINING_TEMPLATE]
