...
export const CATEGORY_GROUPS = Object.freeze({
  grants: { id: 'grants', name: 'Grants', description: 'Pursuit and administration of grants and restricted funds.' },
  onboarding: { id: 'onboarding', name: 'Onboarding', description: 'Bringing members, volunteers, and employees into the organization.' },
  people: { id: 'people', name: 'People', description: 'Employment, contractor, volunteer, and performance operations.' },
  events: { id: 'events', name: 'Events', description: 'Event authorization, execution, and closeout.' },
  safety: { id: 'safety', name: 'Safety', description: 'Incident reporting and safety training.' },
  finance: { id: 'finance', name: 'Finance', description: 'Purchasing, reimbursements, donations, and sponsorship.' },
  assets: { id: 'assets', name: 'Assets', description: 'Acquiring and disposing of organizational assets.' },
});
